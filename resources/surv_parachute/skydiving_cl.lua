local WARNING_HEIGHT = 350 -- height at which the 'open your parachute' message is shown
local slow_speed = 0.75 -- overall (x,y,z) speed limit after which z_accelerate is used
local accelerate_speed = 3 -- forward acceleration speed while holding forward (skydiving)
local z_accelerate = 0.01 -- forward acceleration while not holding any controls (freefalling)
local x_rotation = 60 -- limits how far forwards the player will dip while skydiving forwards
